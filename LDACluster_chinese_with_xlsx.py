...
class LDAClustering():
    ...
    def get_contents(self):
        ...
        contents = queryDataFromXlsx(self.data_file_path)
        return contents
...
if __name__ == '__main__':
    ...
    # 获取词频
    LDA.get_words_freq('models/cc/freq.xlsx')
    for i in range(10):
        lda_num_topics = (i+1)
        print("start "+str(lda_num_topics)+" topic lda model train...")

        dictionary_path = "models/cc/dictionary"+str(lda_num_topics)+".dict"
        corpus_path = "models/cc/corpus"+str(lda_num_topics)+".lda-c"
        lda_model_path = "models/cc/lda_model_"+str(lda_num_topics)+"_topics.lda"
