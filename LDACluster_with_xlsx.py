...
def queryDataFromXlsx(data_file_path):
    ...
    columns = df['answer_content'].values
    aaa = 10
    ...
    #
    # # 选择工作表
    # sheet = workbook['quora_answers_copy']
    # a = sheet.columns
    # # 读取指定列的数据，例如第A列
    # column = sheet['answer_content']
    # sheet.columns
    #
    # # 打印读取的数据
    # for cell in column:
...
if __name__ == '__main__':
    ...
    data_file_path = './data/quora_answers.xlsx'
    ...
    # 获取词频
    LDA.get_words_freq('models/test/freq.xlsx')
    for i in range(20):
        lda_num_topics = (i+1)
